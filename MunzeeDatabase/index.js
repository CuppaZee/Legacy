...
fs.writeFileSync('../PaperZee/db/types.json', JSON.stringify(munzees))
...
fs.writeFileSync('../PaperZee/db/typekeys.json', JSON.stringify(typekeys))
...
fs.writeFileSync('../PaperZee/db/categories.json', JSON.stringify(categories))
