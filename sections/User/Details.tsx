        ...
        <View style={{ alignItems: "stretch", alignSelf: "center", flexDirection: "row", flexWrap: "wrap", justifyContent: "center", width: "100%", maxWidth: 1200 }}>
          ...
          <View style={{ padding: 4, width: 500, maxWidth }}>
            ...
            <Card noPad>
              ...
              {/* @ts-expect-error ts-migrate(2345) FIXME: Argument of type '"captures" | null' is not assign... Remove this comment to see the full error message */}
          ...
          <View style={{ padding: 4, width: 500, maxWidth }}>
            ...
            <Card noPad>
              ...
              {/* @ts-expect-error ts-migrate(2345) FIXME: Argument of type '"challenge" | null' is not assig... Remove this comment to see the full error message */}
