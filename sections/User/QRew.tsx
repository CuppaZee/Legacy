  ...
  return (
    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView
        ...
        {/* @ts-expect-error ts-migrate(2339) FIXME: Property 'pd' does not exist on type '{ amount: bo... Remove this comment to see the full error message */}
          ...
          <Card noPad>
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <View style={{ padding: 8 }}>
                ...
                {/* @ts-expect-error ts-migrate(2339) FIXME: Property 'm' does not exist on type '{ amount: boo... Remove this comment to see the full error message */}
              ...
              <View style={{ padding: 8, paddingLeft: 0, flex: 1, justifyContent: "center" }}>
                ...
                {/* @ts-expect-error ts-migrate(2339) FIXME: Property 'notext' does not exist on type '{ amount... Remove this comment to see the full error message */}
