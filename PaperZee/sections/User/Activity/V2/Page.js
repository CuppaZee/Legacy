...
import { ActivityIndicator, FAB, IconButton, Menu, TouchableRipple } from 'react-native-paper';
...
export default function UserActivityScreen() {
  ...
  return <View style={{ flex: 1 }}>
    ...
    getItemLayout={(data, index) => (
      ...
      keyExtractor={(item, index) => `${item.username}/${item.code}/${item.captured_at ?? item.deployed_at}`}
    />
    <FAB.Group
      open={FABOpen}
