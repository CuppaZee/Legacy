          ...
          <Card noPad>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <View style={{ padding: 8, paddingLeft: 0, flex: 1, justifyContent: "center" }}>
                <Text style={{ fontSize: 20, fontWeight: "bold", color: theme.page_content.fg }} numberOfLines={1} ellipsizeMode={"tail"}>{data?.username}</Text>
                <Text style={{ fontSize: 16, fontWeight: "500", color: theme.page_content.fg, opacity: 0.8 }}><MaterialCommunityIcons name="arrow-up-bold-hexagon-outline" size={16} /> Level {data?.level}</Text>
                <Text style={{ fontSize: 16, fontWeight: "500", color: theme.page_content.fg, opacity: 0.8 }}><MaterialCommunityIcons name="trophy-outline" size={16} /> Rank #{data?.rank}</Text>
              </View>
            </View>
            ...
            {data?.clan?.id&&<TouchableRipple onPress={() => nav.navigate('Clan', { clanid: data?.clan?.id })}>
              <View style={{ padding: 8, flexDirection: "row", alignItems: "center" }}>
                ...
                <Text style={{ paddingLeft: 4, fontWeight: "bold", fontSize: 16, flex: 1, color: theme.page_content.fg }}>{data?.clan?.name}</Text>
            ...
            <TouchableRipple onPress={() => nav.navigate('UserClan', { userid: user_id })}>
              <View style={{ padding: 8, flexDirection: "row", alignItems: "center" }}>
                ...
                <Text style={{ paddingLeft: 4, fontWeight: "bold", fontSize: 16, flex: 1, color: theme.page_content.fg }}>Clan Progress</Text>
                <MaterialCommunityIcons name="chevron-right" size={24} color={theme.page_content.fg} />
              </View>
            </TouchableRipple>
            <TouchableRipple onPress={() => nav.navigate('UserQuest', { userid: user_id })}>
              <View style={{ padding: 8, flexDirection: "row", alignItems: "center" }}>
                ...
                <Text style={{ paddingLeft: 4, fontWeight: "bold", fontSize: 16, flex: 1, color: theme.page_content.fg }}>Quebec Quest Progress</Text>
                <MaterialCommunityIcons name="chevron-right" size={24} color={theme.page_content.fg} />
              </View>
            </TouchableRipple>
          </Card>
